...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="entri_transaksi3.php">Transaksi</a></h1>
    </div>
    <!--close-Header-part-->
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                <a href="entri_transaksi3.php" title="Entri_Transaksi2" class="tip-bottom"><i
                        class="icon icon-inbox"></i>
                    Entri Transaksi
                </a>
                <a href="transaksi3.php" title="Transaksi" class="tip-bottom"><i class="icon icon-ok"></i>
                    Transaksi
                </a>
            </div>
        </div>
