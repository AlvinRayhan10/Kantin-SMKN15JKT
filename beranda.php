...
//   $result_wtr = mysqli_fetch_array($sql_jml_wtr);
  ...
  //Jumlah Kasir
  $query_jml_ksr = "SELECT COUNT(*) AS jumlah_ksr FROM tb_user WHERE id_level NOT IN (1) AND status = 'aktif'";
...
<body>
  ...
  ?>
            ...
            <li> <a href="daftar.php"><i class="icon icon-user"></i> <span>Tambah Akun</span></a>
            </li>
            <?php
  ...
  ?>
            <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="entri_order3.php"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a> </li>
            <li> <a href="entri_transaksi3.php"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li>
            </li <?php
    } else if($r['id_level'] == 5){
  ?> <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="entri_order4.php"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a> </li>
            <li> <a href="entri_transaksi4.php"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li> <?php
    }
  ?>
        </ul>
    </div>
    ...
    ?>
                ...
                ?>
                      ...
                      ?>
                            ...
                            ?>
                                                            <button name="unvalidasi"
                                                                value="<?php echo $r_dt_adm['id_user']; ?>"
                      ...
                      ?>
                                ...
                                <div class="widget-box">
                                    <?php
                  $query_data_ksr = "select * from tb_user where id_level = 2";
                ...
                ?>
                      ...
                      ?>
                                ...
                                <div class="widget-box">
                                    <?php
                  $query_data_ksr = "select * from tb_user where id_level = 4";
                  $sql_data_ksr = mysqli_query($conn, $query_data_ksr);
                  $no_ksr = 4;
                ?>
                                    <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
                      ...
                      ?>
                                ...
                                <div class="widget-box">
                                    <?php
                  $query_data_ksr = "select * from tb_user where id_level = 5";
                  $sql_data_ksr = mysqli_query($conn, $query_data_ksr);
                  $no_ksr = 5;
                ?>
                                    <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
      ...
      ?>
            <div class="alert alert-orange alert-block">
                <center>
                    <h4 class="alert-heading">HALO <?php echo strtoupper($r['nama_user']);?> SELAMAT DATANG</h4>
                    Di Kantin SMKN 15 Jakarta.
                    <br> Semoga Usahamu Menyenangkan ya.
                </center>
            </div>
            <?php
        }
    ...
    <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; KANTIN <a href="#">SMKN 15 JAKARTA</a>
        </div>
    </div>
