...
if(isset($_SESSION['edit_menu1'])){
  echo $_SESSION['edit_menu1'];
  unset($_SESSION['edit_menu1']);
...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="kasir1.php">Kasir 1</a></h1>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="kasir1.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Kasir
                1</span></a>
        <ul>
            <?php
    if($r['id_level'] == 1){
  ?>
            ...
            <li class="active"> <a href="kasir1.php"><i class="icon icon-tasks"></i> <span>Kasir 1</span></a>
