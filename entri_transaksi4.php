...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="entri_transaksi4.php">Entri Transaksi</a></h1>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="entri_referensi4.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri
                Transaksi kasir 4</span></a>
        <ul>
            <?php
    if($r['id_level'] == 1){
  ?>
  ...
  ?>
            ...
            <li class="active"> <a href="entri_transaksi4.php"><i class="icon icon-inbox"></i> <span>Entri
                        Transaksi</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li>
  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="entri_transaksi4.php" title="Go to here" class="tip-bottom"><i
    ...
    ?>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-invoice-full">
                                ...
                                <tbody>
                                    <?php
                 $query_order =   "SELECT * FROM tb_order LEFT JOIN tb_user ON tb_order.id_pengunjung = tb_user.id_user WHERE tb_user.id_user = $id AND status_order = 'belum bayar'";
                ...
                ?>
                  ...
                  if(isset($_REQUEST['edit_order'])){
                    ...
                    header('location: transaksi4.php');
                  }

                  if(isset($_REQUEST['hapus_order'])){
                    $id_order = $_REQUEST['hapus_order'];
                    $query_hapus_order = "delete from tb_order4 where id_order = $id_order";
                    $query_hapus_pesan_order = "delete from tb_pesan4 where id_order = $id_order";
                    $sql_hapus_order = mysqli_query($conn, $query_hapus_order);
                    $sql_hapus_pesan_order = mysqli_query($conn, $query_hapus_pesan_order);
                    if($sql_hapus_order){
                      header('location: entri_transaksi4.php');
                    }
                  }
                ?>
                                </tbody>
                            ...
                            <table class="table table-bordered table-invoice-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="head1">Nama Kasir</th>
                                        <th class="head0">No Antrian</th>
                                        <th class="head0">Nama Pembeli</th>
                                        <th class="head0 right">Total Harga</th>
                                        <th class="head0 right">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                  $nomor = 2;
                  $query_sudah_order = "SELECT * FROM tb_order LEFT JOIN tb_user ON tb_order.id_pengunjung = tb_user.id_user WHERE tb_user.id_user = $id AND status_order = 'sudah bayar'";
                ...
                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $r_sudah_order['nama_pengunjung'];?></td>
