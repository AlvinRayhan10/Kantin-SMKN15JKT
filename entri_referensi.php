...
<body>
  ...
  ?>
            <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="entri_order2.php"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a> </li>
            <li> <a href="entri_transaksi2.php"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li>
            <?php
  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="kasir1.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-tasks"></i> Kasir 1</a></div>
        </div>
        <!--End-breadcrumbs-->
    ...
    ?>
                        ...
                        <ul class="thumbnails">
                            <div class="btn-icon-pg">
                                <ul>
                                    <!--Looping-->
                                    <?php
                  $query_data_makanan = "select * from tb_masakan JOIN tb_level ON tb_masakan.id_level = tb_level.id_level WHERE tb_level.nama_level = 'kasir1' ORDER BY tb_masakan.id_masakan DESC";
                ...
                ?>
                                    <li class="span2">
                                        ...
                                        <form action="" method="post">
                                            <button type="submit" value="<?php echo $r_dt_makanan['id_masakan'];?>"
                                                name="edit_menu1" class="btn btn-success btn-mini"><i
                    ...
                    if(isset($_REQUEST['edit_menu1'])){
                      //echo $_REQUEST['hapus_menu'];
                      $id_masakan = $_REQUEST['edit_menu1'];
                      $_SESSION['edit_menu1'] = $id_masakan;
                    //   var_dump($_SESSION['edit_menu1']);
    ...
    <div id="content">
        <!--breadcrumbs-->
        <div id="content-header">
            <div id="breadcrumb"> <a href="kasir2.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-tasks"></i> Kasir 2</a></div>
        </div>
        <!--End-breadcrumbs-->
    ...
    ?>
                <div class="widget-box">
                    <div class="widget-title bg_lg"><span class="icon"><i class="icon-th-large"></i></span>
                        <h5>Menu kasir 2</h5>
                        <a href="tambah_menu2.php" class="btn btn-info btn-mini label"><i
                                class="icon-plus"></i>&nbsp;Tambah Menu</a>
                    </div>
                    <div class="widget-content">
                        <ul class="thumbnails">
                            <div class="btn-icon-pg">
                                <ul>
                                    <!--Looping-->
                                    <?php
                  $query_data_makanan = "select * from tb_masakan JOIN tb_level ON tb_masakan.id_level = tb_level.id_level WHERE tb_level.nama_level = 'kasir2' ORDER BY tb_masakan.id_masakan DESC";
                  $sql_data_makanan = mysqli_query($conn, $query_data_makanan);
                  $no_makanan = 1;
                //   var_dump($sql_data_makanan);
                  while($r_dt_makanan = mysqli_fetch_array($sql_data_makanan)){
                ?>
                                    <li class="span2">
                                        <a> <img src="gambar/<?php echo $r_dt_makanan['gambar_masakan']?>" alt=""> </a>
                                        ...
                                        <form action="" method="post">
                                            <button type="submit" value="<?php echo $r_dt_makanan['id_masakan'];?>"
                                                name="edit_menu2" class="btn btn-success btn-mini"><i
                                                    class='icon-pencil'></i>&nbsp;&nbsp;Edit &nbsp;&nbsp;</button>
                                            <button type="submit" value="<?php echo $r_dt_makanan['id_masakan'];?>"
                                                name="hapus_menu" class="btn btn-mini btn-danger"><i
                                                    class='icon icon-trash'></i>&nbsp; Hapus</button>
                    ...
                    if(isset($_REQUEST['edit_menu2'])){
                      //echo $_REQUEST['hapus_menu'];
                      $id_masakan = $_REQUEST['edit_menu2'];
                      $_SESSION['edit_menu2'] = $id_masakan;

                      header('location: tambah_menu2.php');
                    }
                  ?>
                                    <!--End Looping-->
                                </ul>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="kasir3.php" title="Go to here" class="tip-bottom"><i
                        class="icon icon-tasks"></i> Kasir 3</a></div>
        </div>
        <!--End-breadcrumbs-->
    ...
    ?>
                        ...
                        <ul class="thumbnails">
                            <div class="btn-icon-pg">
                                <ul>
                                    <!--Looping-->
                                    <?php
                  $query_data_makanan = "select * from tb_masakan JOIN tb_level ON tb_masakan.id_level = tb_level.id_level WHERE tb_level.nama_level = 'kasir3' ORDER BY tb_masakan.id_masakan DESC";
                  $sql_data_makanan = mysqli_query($conn, $query_data_makanan);
                  $no_makanan = 1;
                ...
                ?>
                                    <li class="span2">
                                        ...
                                        <form action="" method="post">
                                            <button type="submit" value="<?php echo $r_dt_makanan['id_masakan'];?>"
                                                name="edit_menu3" class="btn btn-success btn-mini"><i
                                                    class='icon-pencil'></i>&nbsp;&nbsp;Edit &nbsp;&nbsp;</button>
                                            <button type="submit" value="<?php echo $r_dt_makanan['id_masakan'];?>"
                                                name="hapus_menu" class="btn btn-mini btn-danger"><i
                                                    class='icon icon-trash'></i>&nbsp; Hapus</button>
                    ...
                    if(isset($_REQUEST['hapus_menu'])){
                      ...
                      $sql_hapus_masakan= mysqli_query($conn, $query_hapus_masakan);
                      if($sql_hapus_masakan){
                        header('location: kasir3.php');
                      }
                    }

                    if(isset($_REQUEST['edit_menu3'])){
                      //echo $_REQUEST['hapus_menu'];
                      $id_masakan = $_REQUEST['edit_menu3'];
                      $_SESSION['edit_menu3'] = $id_masakan;

                      header('location: tambah_menu3.php');
                    }
                  ?>
                                    <!--End Looping-->
                                </ul>
    ...
    <div id="content">
        <!--breadcrumbs-->
        <div id="content-header">
            <div id="breadcrumb"> <a href="kasir4.php" title="Go to here" class="tip-bottom"><i
    ...
    ?>
                <div class="widget-box">
                    <div class="widget-title bg_lg"><span class="icon"><i class="icon-th-large"></i></span>
                        <h5>Makanan kasir 4</h5>
                        <a href="tambah_menu4.php" class="btn btn-info btn-mini label"><i
