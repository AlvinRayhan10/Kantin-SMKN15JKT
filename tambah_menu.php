...
if(isset ($_SESSION['username'])){
  ...
  while($r = mysqli_fetch_array($sql)){
    ...
    if(isset($_POST['tambah_menu'])){
        ...
        //echo "<br></br>";
        $query_tambah_masakan = "insert into tb_masakan values ('','$level','$nama_masakan','$harga','$stok','$status_masakan','$gambar')";
...
<body>
    ...
    <!--sidebar-menu-->
    <div id="sidebar">
        <a href="kasir1.php" class="visible-phone">
            <i class="icon icon-tasks"></i> <span>Kasir 1</span>
        </a>
        <ul>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                <a href="kasir1.php" title="kasir1" class="tip-bottom">
    ...
    ?>
                ...
                ?>
                                    <input name="" type="text" value="<?php echo $nama_masakan; ?>" class="span11"
                                        placeholder="Nama Masakan" disabled="" /> <input name="nama_masakan"
                                        type="hidden" value="<?php echo $nama_masakan; ?>" class="span11"
                ...
                ?>
                                    <input name="nama_masakan" type="text" value="" class="span11"
                                        placeholder="Nama Masakan" />
                                    <input name="id_level" type="hidden" value="2" />
                                    <?php
                  }
                ?>
                                </div>
