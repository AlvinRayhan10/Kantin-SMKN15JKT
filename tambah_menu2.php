...
<body>
    ...
    <!--sidebar-menu-->
    <div id="sidebar">
        <a href="kasir2.php" class="visible-phone">
            <i class="icon icon-tasks"></i> <span>Kasir 2</span>
        </a>
        <ul>
    ...
    <div id="content">
      ...
      if(isset($_SESSION['edit_menu2'])){
      ?>
                <a href="tambah_menu2.php" title="Tambah Menu" class="tip-bottom">
                    <i class="icon icon-tasks"></i>
                    Ubah Detail Menu
                </a>
                <?php 
    ...
    ?>
                ...
                ?>
                                    ...
                                    <input name="id_level" type="hidden" value="3" />
