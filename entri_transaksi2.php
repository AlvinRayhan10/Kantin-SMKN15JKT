...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="entri_transaksi2.php">Entri Transaksi</a></h1>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="entri_referensi2.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri
                Transaksi kasir 2</span></a>
        <ul>
            <?php
    if($r['id_level'] == 1){
  ?>
  ...
  ?>
            ...
            <li class="active"> <a href="entri_transaksi2.php"><i class="icon icon-inbox"></i> <span>Entri
                        Transaksi</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li>
  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="entri_transaksi2.php" title="Go to here" class="tip-bottom"><i
    ...
    ?>
                ...
                ?>
                  ...
                  if(isset($_REQUEST['hapus_order'])){
                    ...
                    if($sql_hapus_order){
                      header('location: entri_transaksi2.php');
                    }
                  }
                ?>
                                </tbody>
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-invoice-full">
                                ...
                                <tbody>
                                    <?php
                  $nomor = 1;
                  $query_sudah_order = "SELECT * FROM tb_order LEFT JOIN tb_user ON tb_order.id_pengunjung = tb_user.id_user WHERE tb_user.id_user = $id AND status_order = 'sudah bayar' order by id_order desc";
