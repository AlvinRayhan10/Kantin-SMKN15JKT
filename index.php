...
<head>
    <title>Masuk || SMKN 15 JAKARTA</title>
    <meta charset="UTF-8">
...
<body>
                ...
                <form action="" method="post" class="login100-form validate-form">
                    ...
                    <div class='container'>
                        <div class='alert alert-danger'>
                            <span>
                                <center>Masukkan Username Dan Password Dengan Benar!</center>
                            </span>
                        </div>
                    </div>
                    <?php 
                    ...
                    <div class="login100-form-avatar">
                        <img src="gambar/logo155.jpg" alt="AVATAR">
                    </div>

                    <span class="login100-form-title p-t-20 p-b-45">
                        Kantin SMKN 15 Jakarta
                    </span>
                    <div class="wrap-input100 validate-input m-b-10" data-validate="Masukkan Username Dengan Benar!">
                    ...
                    <div class="wrap-input100 validate-input m-b-10" data-validate="Masukkan Password Dengan Benar!">
    ...
    <script>
    {
        let login = confirm("Masukkan Username Dan Password Dengan Benar! ");
        if (login) {
