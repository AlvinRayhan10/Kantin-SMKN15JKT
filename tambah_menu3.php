...
if(isset ($_SESSION['username'])){
  ...
  if(isset($_SESSION['edit_menu3'])){
    $id = $_SESSION['edit_menu3'];
...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="kasir3.php">Kasir 3</a></h1>
    </div>
    <!--close-Header-part-->
    ...
    <!--sidebar-menu-->
    <div id="sidebar">
        <a href="kasir3.php" class="visible-phone">
            <i class="icon icon-tasks"></i> <span>Kasir 3</span>
        </a>
        <ul>
            ...
            <li class="active"> <a href="kasir3.php"><i class="icon icon-tasks"></i> <span>Kasir 3</span></a>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                <a href="kasir2.php" title="kasir2" class="tip-bottom">
      ...
      if(isset($_SESSION['edit_menu3'])){
      ?>
                <a href="tambah_menu3.php" title="Tambah Menu" class="tip-bottom">
                    <i class="icon icon-tasks"></i>
                    Ubah Detail Menu
                </a>
                <?php 
    ...
    ?>
                ...
                ?>
                                    <input name="nama_masakan" type="text" value="" class="span11"
                                        ...
                                        <input name="id_level" type="hidden" value="4"/>
