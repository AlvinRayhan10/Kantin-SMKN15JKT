  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="entri_order4.php" title="Go to here" class="tip-bottom"><i
      ...
      ?>
            <div class="row-fluid">
                <div class="span8">
                    ...
                    $query_data_makanan = "SELECT * FROM tb_masakan WHERE stok > 0 AND id_level = 5 ORDER BY id_masakan DESC";
                  ...
                  ?>
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        if($sql_tambah_pesan){
                          header('location: entri_order4.php');
                        }
                      }
                    ?>
                                        <!--End Looping-->
