...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="entri_transaksi3.php">Entri Transaksi</a></h1>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="entri_referensi3.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri
                Transaksi kasir 3</span></a>
        <ul>
            <?php
    if($r['id_level'] == 1){
  ?>
  ...
  ?>
            <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="entri_order3.php"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a> </li>
            <li class="active"> <a href="entri_transaksi3.php"><i class="icon icon-inbox"></i> <span>Entri
                        Transaksi</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Generate Laporan</span></a> </li>
  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="entri_transaksi3.php" title="Go to here" class="tip-bottom"><i
    ...
    ?>
                ...
                ?>
                  ...
                  if(isset($_REQUEST['edit_order'])){
                    ...
                    header('location: transaksi3.php');
                  }
                  ...
                  if(isset($_REQUEST['hapus_order'])){
                    ...
                    if($sql_hapus_order){
                      header('location: entri_transaksi3.php');
                    }
                  }
                ?>
                                </tbody>
