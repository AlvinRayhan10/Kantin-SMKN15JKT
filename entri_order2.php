...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="entri_order2.php">Entri Order</a></h1>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="entri_order2.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Entri
                Order</span></a>
        <ul>
            <?php
    if($r['id_level'] == 1){
  ...
  ?>
            <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li class="active"> <a href="entri_order2.php"><i class="icon icon-shopping-cart"></i> <span>Entri
                        Order</span></a> </li>
  ...
  ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="entri_order2.php" title="Go to here" class="tip-bottom"><i
                    ...
                    <div class="widget-box span12">
                        ...
                        <div class="widget-content">
                            <div class="alert alert-info alert-block">
                                ...
                                Silahkan tunggu pesanan anda sesuai dengan antrian anda!
                            </div>
                        </div>
                    </div>
                </div>
      ...
      ?>
            <div class="row-fluid">
                <div class="span8">
                    ...
                    $query_data_makanan = "SELECT * FROM tb_masakan WHERE stok > 0 AND id_level = 3 ORDER BY id_masakan DESC";
                  ...
                  ?>
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        if($sql_tambah_pesan){
                          header('location: entri_order2.php');
                        }
                      }
                    ?>
                                        <!--End Looping-->
              ...
              ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <center>
                                                    <input class="span8" name="no_antrian" type="number" value=""
                                                        placeholder="" />
                                                </center>
                                            </td>
                                            <td>
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $time = Date('YmdHis');
            echo $time;
            $query_simpan_order = "insert into tb_order values('', '$id_admin', '$id_pengunjung', '$nama_pengunjung', $time, '$no_meja', '$total_harga', '$uang_bayar', '$uang_kembali', '$status_order')";
