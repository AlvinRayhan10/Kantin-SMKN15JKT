...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="entri_transaksi2.php">Transaksi</a></h1>
    </div>
    <!--close-Header-part-->
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                <a href="entri_transaksi2.php" title="Entri_Transaksi2" class="tip-bottom"><i
                        class="icon icon-inbox"></i>
                    Entri Transaksi
                </a>
                <a href="transaksi2.php" title="Transaksi" class="tip-bottom"><i class="icon icon-ok"></i>
                    Transaksi
                </a>
            </div>
        </div>
    ...
    ?>
                        ...
                        <div class="widget-content nopadding">
                            <form action="#" method="post" class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="nama" name="nama" class="span11"
                                            placeholder=""/>
                                    </div>
                                </div>
                                <div class="control-group">
          ...
          if(isset($_REQUEST['save_order'])){
            ...
            $query_save_transaksi = "UPDATE tb_order SET id_admin = $id, uang_bayar = $uang_bayar, uang_kembali = $uang_kembali, status_order = 'sudah bayar', nama_pengunjung = '$nama_pengunjung'  WHERE id_order = $id_order";
