...
if(isset($_SESSION['edit_menu2'])){
  echo $_SESSION['edit_menu2'];
  unset($_SESSION['edit_menu2']);
...
<body>
    ...
    <!--Header-part-->
    <div id="header">
        <h1><a href="kasir2.php">Kasir 2</a></h1>
    ...
    <!--close-top-serch-->
    <!--sidebar-menu-->
    <div id="sidebar"><a href="kasir2.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Kasir
                1</span></a>
        <ul>
            <?php
    if($r['id_level'] == 1){
  ?>
            ...
            <li> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Entri
                        Referensi</span></a>
            <li> <a href="kasir1.php"><i class="icon icon-tasks"></i> <span>Kasir 1</span></a>
            <li class="active"> <a href="kasir2.php"><i class="icon icon-tasks"></i> <span>Kasir 2</span></a>
